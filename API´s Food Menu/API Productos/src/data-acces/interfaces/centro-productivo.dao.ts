...
export interface CentroProductivoIDAO {
     ...
     */
    getCentrosProductivos(): Promise<CentroProductivo[]>;
    /**
     ...
     */
    getCentroProductivoById(centroProductivoId: Number): Promise<CentroProductivo>;
    /**
     ...
     */
    getCentroProductivoByUuid(centroProductivoUuid: String): Promise<CentroProductivo>;
     ...
     */
    agregarCentroProductivo(centroProductivo: CentroProductivo): Promise<Boolean>;
    /**
     ...
     */
    actualizarCentroProductivo(centroProductivo: CentroProductivo): Promise<Boolean>;
    /**
     ...
     */
    eliminarCentroProductivoById(centroProductivoId: Number): Promise<Boolean>;
}